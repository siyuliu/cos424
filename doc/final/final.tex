...
% Therefore, in spite of the fact that most of the model evaluation is
% based on visual check in this project, we hope our observations and
% analysis could make a plausible case for the advantage of LaserCut
