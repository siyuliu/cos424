...
In figure [], the margin of ``background'' is curvy and very close to
the true boundary between green leaves and sky. From the distance
...
segmentation. 
For example, in figure [], although the white cars have similar color
